        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Laporan Pembayaran</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan Pembayaran</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Laporan Pembayaran</h4>
                            <div class="table-responsive">
                                ...
                                @endif
                                <div class="card-body">
                                    <table class="table table-bordered" id="get-lpbayar">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>No Pengajuan</th>
                                        ...
                                        <div class="modal-body">
                                            <form action="javascript:void(0)" id="CompanyForm" name="CompanyForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="jumlah_pembayaran" name="jumlah_pembayaran" placeholder="Input Jumlah Pembayaran" maxlength="50" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#get-lpbayar').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('get-lpbayar') }}",
            columns: [{
                    data: 'no_pembayaran',
                    name: 'no_pembayaran'
                },
    ...
    function add() {
        ...
        $('#CompanyModal').html("Tambah Laporan Pembayaran");
    ...
    function deleteFunc(id) {
        if (confirm("Delete Record?") == true) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('delete-lpbayar') }}",
                data: {
                    id: id
                },
                dataType: 'json',
                success: function(res) {
                    var oTable = $('#get-lpbayar').dataTable();
                    oTable.fnDraw(false);
                }
            });
        }
