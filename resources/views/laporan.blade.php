                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h2 class="text-muted fw-medium">Laporan Penyewaan</h2>
                            ...
                            <a href="{{ route('tarif.index') }}" >
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h2 class="text-muted fw-medium">Laporan Pengembalian</h2>
                            ...
                            <a href="{{ route('mobil.index') }}" >
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h2 class="text-muted fw-medium">Laporan Master</h2>
                            ...
                            <a href="{{ route('kondisi.index') }}" >
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <h2 class="text-muted fw-medium">Laporan Jurnal</h2>
                                                {{-- <h4 class="mb-0">1,235</h4> --}}
                                            </div>
